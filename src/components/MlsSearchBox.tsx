...
export const MlsSearchBox = () => {
  ...
  return (
    ...
    >
      <form onSubmit={handleSearch} className="bg-white/10 backdrop-blur-xl rounded-lg p-4 md:p-6 border border-white/20">
        {/* Main Search Row */}
        <div className="grid grid-cols-1 md:grid-cols-12 gap-3">
          ...
          <div className="md:col-span-4 relative">
            ...
            <input
              ...
              className="w-full bg-white/10 border border-white/20 rounded px-10 py-3 text-white placeholder:text-white/50 text-sm focus:outline-none focus:border-accent/50 transition-colors"
            />
          </div>
          ...
          <div className="md:col-span-3 grid grid-cols-2 gap-2">
            <div className="relative">
              ...
              <select
                ...
                className="w-full bg-white/10 border border-white/20 rounded px-6 py-3 text-white text-sm focus:outline-none focus:border-accent/50 transition-colors appearance-none cursor-pointer"
              >
          ...
          <div className="md:col-span-2 relative">
            ...
            <select
              ...
              className="w-full bg-white/10 border border-white/20 rounded px-10 py-3 text-white text-sm focus:outline-none focus:border-accent/50 transition-colors appearance-none cursor-pointer"
            >
          ...
          <div className="md:col-span-1">
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="w-full h-full bg-accent hover:bg-gold-light text-white rounded flex items-center justify-center transition-colors duration-300 min-h-[46px]"
            >
